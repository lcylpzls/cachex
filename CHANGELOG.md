...
- `TraceHook` / `TraceAttr` 契约迁移至零依赖子模块
  `tracex/contract`（v1.0.0），cachex 不再依赖 tracex 主模块。
...
- 清理过期规划文档（PRD/research/design/decisions/iteration-plan 等）；
...
- 依赖升级：tracex v1.0.4、metricsx v1.5.4、errx v1.5.7、validx v1.2.5、testx v1.4.5。
